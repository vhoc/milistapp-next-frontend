...
const ContactButton = ({ catalog, product, contactMethod }: ContactButtonProps) => {
    ...
    const typeLinks: { [key:string]: string } = {
        ...
        "whatsapp" : catalog.id && product.hexId ? `https://wa.me/52${ contactMethod.value }?text=%C2%A1Hola%21%20Vi%20tu%20cat%C3%A1logo%20y%20me%20interesa%20%C3%A9ste%20producto%3A%20https%3A%2F%2F${ domain }%2Fproducts%2F${ product.hexId }` : '',
        "facebook" : catalog.id && product.hexId ? `http://m.me/${ contactMethod.value }?text=%C2%A1Hola%21%20Vi%20tu%20cat%C3%A1logo%20y%20me%20interesa%20%C3%A9ste%20producto%3A%20https%3A%2F%2F${ domain }%2Fproducts%2F${ product.hexId }` : '',
